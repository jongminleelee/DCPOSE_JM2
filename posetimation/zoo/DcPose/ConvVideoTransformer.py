...
from .blocks import LayerNorm, get_sinusoid_encoding, TransformerBlock
...
class ConvTransformer(nn.Module):
    ...
    def __init__(
        ...
        ''' Flow encoder
        self.arch = {tuple 3} (0, 6, 2)
        self.mha_win_size = {list 6} [-1, -1, -1, -1, -1, -1]
        self.max_len = 6912
        ...
        if self.use_abs_pe:
            # n_embd = 136, pos_embd = [1, 136, 6912] = [ , c*8, h*w]
    ...
    def forward(self, x):
        ...
        # return out_feats[0]
        # out_feats = {tuple 3} = out_feats[0] == [2, 136, 6912] == [b, c*8, h*w]
        return out_feats
